...
plotcolours <-  c("Obs" = "red3", "IVW" = "blue3", "MR Egger" = "green4", "W. Median" = "darkorchid", "W. Mode" = "darkorange", "MVMR" = "darkgoldenrod1")
desired_order <- c("Obs", "IVW", "MR Egger", "W. Median", "W. Mode", "MVMR")
```
...
resb_fig1$Estimator <- factor(resb_fig1$Estimator, levels = c("Obs", "IVW", "MR Egger", "W. Median", "W. Mode", "MVMR"))
...
resc_fig1$Estimator <- factor(resc_fig1$Estimator, levels = c("Obs", "IVW", "MR Egger", "W. Median", "W. Mode", "MVMR"))
...
resc_fig2$Estimator <- factor(resc_fig2$Estimator, levels = c("Obs", "IVW", "MR Egger", "W. Median", "W. Mode"))
...
resa_fig1$Estimator <- factor(resa_fig1$Estimator, levels = c("Obs", "IVW", "MR Egger", "W. Median", "W. Mode", "MVMR"))
resa_fig1$Steiger <- "No"
resa_fig1$PropC <- "50%"
